...
function ProjectDashboard() {
      ...
      <Box mt="md" p="md" bg="rgba(0, 40, 100, 0.05)" style={{ borderRadius: '8px', border: '1px solid rgba(100, 180, 255, 0.15)' }}>
        <Stack gap="md">
          <Group justify="space-between">
            <Title order={5}>{projectDetails.name}</Title>
            <Group gap="xs">
              <Badge 
              ...
              {projectDetails.has_zip && (
                <Button 
                  ...
                  download
                >
                  Download ({formatFileSize(projectDetails.zip_size)})
                </Button>
              )}
            </Group>
          </Group>
  ...
  return (
    <Stack gap="xl">
      <Title order={2} ta="center">Project Dashboard</Title>
      
      <Paper shadow="sm" p="md" radius="md" withBorder>
        <Title order={3} mb="md">Project History</Title>
            ...
            {projects.map((project, index) => (
              <Box key={project.id}>
                <Paper 
                  ...
                  style={{ 
                    cursor: 'pointer',
                    backgroundColor: selectedProject === project.id ? 'rgba(100, 180, 255, 0.1)' : 'transparent',
                    ...
                    <Group gap="md" align="center">
                      ...
                      <Box>
                        ...
                        <Text size="sm" c="dimmed">
                          ID: {project.id} • Created: {formatDate(project.creation_time)}
                        </Text>
                      </Box>
                    </Group>
                      ...
                      {project.has_zip && (
                        ...
                        >
                          <Group gap="xs">
                            ...
                            <Text size="sm">({formatFileSize(project.zip_size)})</Text>
                          </Group>
                        </Anchor>
                      )}
                    </Group>
